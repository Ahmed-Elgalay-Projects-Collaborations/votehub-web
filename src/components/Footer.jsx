        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-socials" style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
              <a href="#" className="social-icon" aria-label="Twitter / X" style={{ color: 'var(--text)', transition: 'color 0.2s' }} onMouseOver={e => e.currentTarget.style.color='var(--primary)'} onMouseOut={e => e.currentTarget.style.color='var(--text)'}>
              ...
              <a href="#" className="social-icon" aria-label="LinkedIn" style={{ color: 'var(--text)', transition: 'color 0.2s' }} onMouseOver={e => e.currentTarget.style.color='var(--primary)'} onMouseOut={e => e.currentTarget.style.color='var(--text)'}>
              ...
              <a href="#" className="social-icon" aria-label="GitHub" style={{ color: 'var(--text)', transition: 'color 0.2s' }} onMouseOver={e => e.currentTarget.style.color='var(--primary)'} onMouseOut={e => e.currentTarget.style.color='var(--text)'}>
